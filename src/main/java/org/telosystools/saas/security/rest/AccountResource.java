package org.telosystools.saas.security.rest;
...
import org.telosystools.saas.security.rest.dto.UserDTO;
import org.telosystools.saas.security.security.SecurityUtils;
import org.telosystools.saas.security.service.MailService;
import org.telosystools.saas.security.service.UserService;
        ...
        return Optional.ofNullable(userService.getUserWithAuthorities())
            .map(user -> new ResponseEntity<>(
                new UserDTO(
                    ...
                    user.getEmail(),
                    user.getLangKey(),
                    user.getAuthorities().stream().map(Authority::getName).collect(toCollection(LinkedList::new))),
                HttpStatus.OK))
            .orElse(new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR));
    }
